    ...
    <div class="container-fluid">
        ...
        <div class="main-header-right">
            <li style="margin-left:-15px " class="nav-item dropdown">
                <a style="color: black" class="nav-link dropdown-toggle nav-link" href="#" role="button"
                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <span class="hidden-md-down">{{ LaravelLocalization::getCurrentLocaleNative() }}
                    </span>
                </a>
            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href=""><img alt=""
                            class="rounded-circle avatar-md mr-2" src="{{ asset(Auth::user()->image) }}"></a>
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                <div><img alt="" style="width: 50px; height: 50px;border-radius:20px "
                                        src="{{ asset(Auth::user()->image) }}" class="rounded-circle avatar-md mr-2">
                                </div>
