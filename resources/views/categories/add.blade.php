...
@section('title')
    {{ trans('words.title') }} | {{ trans('words.addCategory') }}
@endsection
@section('css')
...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ __('words.addCategory') }}</h4>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div style="margin-bottom: 10px;margin-right:30px;"
                                                        ...
                                                        <div class="col-sm-2 col-md-2">
                                                            <button type="submit"
                                                                class="btn btn-primary btn-block">{{ trans('words.addCategory') }}</button>
                                                        </div>
                                                    </div>
