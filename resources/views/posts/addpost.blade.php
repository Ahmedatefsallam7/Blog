...
@section('title')
    {{ trans('words.title') }} | {{ trans('words.addPost') }}
@endsection
@section('css')
...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{ __('words.addPost') }}</h4>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="example">
                                                            ...
                                                            <div class="row row-xs align-items-center mg-b-20">
                                                                <div class="col-md-0">
                                                                    <label
                                                                        class="form-label mg-b-0">{{ __('words.categ') }}</label>
                                                                </div>
                                                                <div class="col-md-20 mg-t-5 mg-md-t-0">
                                                                    <input class="form-control" name='image'
                                                                        placeholder="{{ __('words.titPlace') }}"
                                                                        type="file">
                                                                </div>
                                                            </div>
                                                            <!-- end image -->
                                                                            ...
                                                                            <div class="tab-pane @if ($loop->index == 0) active @endif"
                                                                                ...
                                                                                <div>
                                                                                    ...
                                                                                    <textarea cols="60%" rows="6%" class="form-control" name="{{ $key }}[smallDescription]"
                                                                                        id="content" placeholder="{{ __('words.contentPlace') }}">{{ $setting->translate($key)->content }}</textarea>
                                                                                </div>
                                                                                <br>
                                                                                <!-- content -->
                                                                                <div>
                                                                                    ...
                                                                                    <textarea cols="60%" rows="10%" class="form-control" name="{{ $key }}[content]" id="content"
                                                                                        placeholder="{{ __('words.contentPlace') }}">{{ $setting->translate($key)->content }}</textarea>
                                                                                </div>
                                                                                <br>
                                                                                <!-- tags -->
                                                                                <div>
                                                                                    ...
                                                                                    <!-- the name must be array to take more than one langauges -->
                                                                                    <textarea cols="60%" rows="2%" class="form-control" name="{{ $key }}[tags]" id="content"
                                                                                        placeholder="{{ __('words.contentPlace') }}">{{ $setting->translate($key)->content }}</textarea>
                                                                                </div>
                                                                            </div>
                                                                        @endforeach
                                                    ...
                                                    <div style="margin-bottom: 10px;margin-right:30px;"
                                                        ...
                                                        <div class="col-sm-2 col-md-2">
                                                            <button type="submit"
                                                                class="btn btn-primary btn-block">{{ trans('words.addPost') }}</button>
                                                        </div>
                                                    </div>
