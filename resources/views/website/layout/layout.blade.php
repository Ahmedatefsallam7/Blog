...
<head>
    ...
    <meta content="Free HTML Templates" name="{{ $setting->translate(app()->getLocale())->content }}">

    <!-- Favicon -->
    <link href="{{ asset($setting->favicon) }}">
...
<body>
    ...
    <div class="container-fluid">
        <div style="background-color: white" class="col-12 col-md-8">
            <div class="d-flex justify-content-between">
                ...
                <div class="owl-carousel owl-carousel-1 tranding-carousel position-relative d-inline-flex align-items-center ml-3"
                    ...
                    @foreach ($lastFivePosts as $posts)
                        <div class="text-truncate"><a class="text-secondary" href="">{{ $posts->title }}</a>
                        </div>
                    @endforeach
                </div>
                <div style="background-color: white" class="col-md-4 text-right d-none d-md-block">
                    {{ date('D  Y M d') }}
                </div>
            </div>
        </div>
        <div class="row align-items-center py-2 px-lg-5">
            ...
            <div class="col-lg-4">
                <a href="" class="navbar-brand d-none d-lg-block">
                    <img height="70px" style="border-radius:15px " src="{{ asset($setting->logo) }}" alt="">
                </a>
            </div>
                ...
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle"
                            data-toggle="dropdown">{{ __('words.catg') }}</a>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 pt-3 pt-lg-0">
                    ...
                    <div class="pb-3">
                        ...
                        <div class="d-flex mb-3">
                            <a href="{{ $setting->facebook }}" class="d-block w-50 py-2 px-3 text-white text-decoration-none mr-2"
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 mb-5">
                <a href="index.html" class="navbar-brand">
                    ...
                    <img height="70px" style="border-radius: 15px" src="{{ asset($setting->logo) }}"
                        alt="">
                </a>
            ...
            <div class="col-lg-3 col-md-6 mb-5">
                <h4 class="font-weight-bold mb-4">{{ __('words.catg') }}</h4>
                <div class="d-flex flex-wrap m-n1">
                    @foreach ($categories as $category)
                        <a href="" class="btn btn-sm btn-outline-secondary m-1">{{ $setting->title }}</a>
                    @endforeach
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-5">
